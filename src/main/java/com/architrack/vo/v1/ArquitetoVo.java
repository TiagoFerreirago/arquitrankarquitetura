...
@JsonPropertyOrder({"id","nome","telefone","email","enderecos","projetos","tipo"})
public class ArquitetoVo extends RepresentationModel<ArquitetoVo> implements Serializable {

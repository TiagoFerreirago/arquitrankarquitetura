...
import com.architrack.security.jwt.JwtTokenFilter;
...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		JwtTokenFilter custom = new JwtTokenFilter(provider);
		return http.httpBasic(basic -> basic.disable())
				.csrf(AbstractHttpConfigurer::disable )
				.addFilterBefore(custom, UsernamePasswordAuthenticationFilter.class)
